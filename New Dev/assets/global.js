...
document.querySelector("#menu-drawer .currency-picker__btn")?.addEventListener('click',function(){
    document.querySelector("#CurrencyModal").classList.add('modal--is-active')
})
document.querySelector(".header__icons .currency-picker__btn")?.addEventListener('click',function(){
    document.querySelector("#CurrencyModal").classList.add('modal--is-active')
})
document.querySelector("#CurrencyModal .modal__close")?.addEventListener('click',function(){
    document.querySelector("#CurrencyModal").classList.remove('modal--is-active')
})
setTimeout(function(){
